...
- **2026-09-22 — The crop model is at chance (0.556) on downscaled input.** Its
  fingerprint is scale-specific: recompression costs 0.013, resizing removes everything.
