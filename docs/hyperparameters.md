...
| `stem_stride` | 1 (headline) / 2 (test21) | ✓ tried + cited | Gragnaniello et al. 2021: early downsampling destroys the GAN fingerprint. **Tried 2026-09-24**: stride 2 gives test AUC 0.9990 vs 0.9996 (acc 0.984 vs 0.99), converging in ~130 epochs instead of ~10, for 4× fewer MACs, CPU 4.0 vs 6.4 ms, 158 vs 171 MB at bs=1, 1.0 vs 2.8 GB at bs=144. The citation holds as "slower and slightly worse", not "destroyed". | **decided 2026-09-25**: 3 seeds each, stride 1 0.9998 ± 0.0002 vs stride 2 0.9988 ± 0.0002 — real gap, stride 1 stays |
